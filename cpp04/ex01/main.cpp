...
int main() {
    testAnimalBasics(); //test polymorphisme + test destructeur virtuel
    testAnimalArray(); //same mais avec un tableau d'animaux = en serie 
    testDeepCopy(); // test deep copy cad double delete + pb de memoire
